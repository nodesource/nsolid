...
PROTOBUF_CONSTEXPR BlockedLoop::BlockedLoop(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.common_)*/nullptr
  , /*decltype(_impl_.body_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct BlockedLoopDefaultTypeInternal {
  PROTOBUF_CONSTEXPR BlockedLoopDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~BlockedLoopDefaultTypeInternal() {}
  union {
    BlockedLoop _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 BlockedLoopDefaultTypeInternal _BlockedLoop_default_instance_;
...
PROTOBUF_CONSTEXPR UnblockedLoop::UnblockedLoop(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.common_)*/nullptr
  , /*decltype(_impl_.body_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct UnblockedLoopDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UnblockedLoopDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~UnblockedLoopDefaultTypeInternal() {}
  union {
    UnblockedLoop _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UnblockedLoopDefaultTypeInternal _UnblockedLoop_default_instance_;
}  // namespace grpcagent
...
const uint32_t TableStruct_blocked_5floop_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::grpcagent::BlockedLoop, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcagent::BlockedLoop, _impl_.common_),
  PROTOBUF_FIELD_OFFSET(::grpcagent::BlockedLoop, _impl_.body_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::grpcagent::UnblockedLoop, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::grpcagent::UnblockedLoop, _impl_.common_),
  PROTOBUF_FIELD_OFFSET(::grpcagent::UnblockedLoop, _impl_.body_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::grpcagent::Stack)},
  { 11, -1, -1, sizeof(::grpcagent::BlockedLoopBody)},
  { 21, -1, -1, sizeof(::grpcagent::BlockedLoop)},
  { 29, -1, -1, sizeof(::grpcagent::UnblockedLoopBody)},
  { 38, -1, -1, sizeof(::grpcagent::UnblockedLoop)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::grpcagent::_Stack_default_instance_._instance,
  &::grpcagent::_BlockedLoopBody_default_instance_._instance,
  &::grpcagent::_BlockedLoop_default_instance_._instance,
  &::grpcagent::_UnblockedLoopBody_default_instance_._instance,
  &::grpcagent::_UnblockedLoop_default_instance_._instance,
};
...
const char descriptor_table_protodef_blocked_5floop_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "k\030\004 \003(\0132\020.grpcagent.Stack\"b\n\013BlockedLoop"
  "\022)\n\006common\030\001 \001(\0132\031.grpcagent.CommonRespo"
  "nse\022(\n\004body\030\002 \001(\0132\032.grpcagent.BlockedLoo"
  ...
  "\0132\034.grpcagent.UnblockedLoopBodyb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_blocked_5floop_2eproto = {
    false, false, 559, descriptor_table_protodef_blocked_5floop_2eproto,
    "blocked_loop.proto",
...
class BlockedLoop::_Internal {
 public:
  static const ::grpcagent::CommonResponse& common(const BlockedLoop* msg);
  static const ::grpcagent::BlockedLoopBody& body(const BlockedLoop* msg);
};

const ::grpcagent::CommonResponse&
BlockedLoop::_Internal::common(const BlockedLoop* msg) {
  return *msg->_impl_.common_;
}
const ::grpcagent::BlockedLoopBody&
BlockedLoop::_Internal::body(const BlockedLoop* msg) {
  return *msg->_impl_.body_;
}
void BlockedLoop::clear_common() {
  if (GetArenaForAllocation() == nullptr && _impl_.common_ != nullptr) {
    delete _impl_.common_;
  }
  _impl_.common_ = nullptr;
}
BlockedLoop::BlockedLoop(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:grpcagent.BlockedLoop)
}
BlockedLoop::BlockedLoop(const BlockedLoop& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  BlockedLoop* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.common_){nullptr}
    , decltype(_impl_.body_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:grpcagent.BlockedLoop)
}

inline void BlockedLoop::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
BlockedLoop::~BlockedLoop() {
  // @@protoc_insertion_point(destructor:grpcagent.BlockedLoop)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void BlockedLoop::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.common_;
  if (this != internal_default_instance()) delete _impl_.body_;
}

void BlockedLoop::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void BlockedLoop::Clear() {
// @@protoc_insertion_point(message_clear_start:grpcagent.BlockedLoop)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* BlockedLoop::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* BlockedLoop::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:grpcagent.BlockedLoop)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:grpcagent.BlockedLoop)
  return target;
}

size_t BlockedLoop::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:grpcagent.BlockedLoop)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData BlockedLoop::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    BlockedLoop::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*BlockedLoop::GetClassData() const { return &_class_data_; }


void BlockedLoop::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<BlockedLoop*>(&to_msg);
  auto& from = static_cast<const BlockedLoop&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:grpcagent.BlockedLoop)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void BlockedLoop::CopyFrom(const BlockedLoop& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:grpcagent.BlockedLoop)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool BlockedLoop::IsInitialized() const {
  return true;
}

void BlockedLoop::InternalSwap(BlockedLoop* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BlockedLoop, _impl_.body_)
      + sizeof(BlockedLoop::_impl_.body_)
      - PROTOBUF_FIELD_OFFSET(BlockedLoop, _impl_.common_)>(
          reinterpret_cast<char*>(&_impl_.common_),
          reinterpret_cast<char*>(&other->_impl_.common_));
}

::PROTOBUF_NAMESPACE_ID::Metadata BlockedLoop::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_blocked_5floop_2eproto_getter, &descriptor_table_blocked_5floop_2eproto_once,
...
class UnblockedLoop::_Internal {
 public:
  static const ::grpcagent::CommonResponse& common(const UnblockedLoop* msg);
  static const ::grpcagent::UnblockedLoopBody& body(const UnblockedLoop* msg);
};

const ::grpcagent::CommonResponse&
UnblockedLoop::_Internal::common(const UnblockedLoop* msg) {
  return *msg->_impl_.common_;
}
const ::grpcagent::UnblockedLoopBody&
UnblockedLoop::_Internal::body(const UnblockedLoop* msg) {
  return *msg->_impl_.body_;
}
void UnblockedLoop::clear_common() {
  if (GetArenaForAllocation() == nullptr && _impl_.common_ != nullptr) {
    delete _impl_.common_;
  }
  _impl_.common_ = nullptr;
}
UnblockedLoop::UnblockedLoop(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:grpcagent.UnblockedLoop)
}
UnblockedLoop::UnblockedLoop(const UnblockedLoop& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  UnblockedLoop* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.common_){nullptr}
    , decltype(_impl_.body_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:grpcagent.UnblockedLoop)
}

inline void UnblockedLoop::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
UnblockedLoop::~UnblockedLoop() {
  // @@protoc_insertion_point(destructor:grpcagent.UnblockedLoop)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void UnblockedLoop::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.common_;
  if (this != internal_default_instance()) delete _impl_.body_;
}

void UnblockedLoop::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void UnblockedLoop::Clear() {
// @@protoc_insertion_point(message_clear_start:grpcagent.UnblockedLoop)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* UnblockedLoop::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* UnblockedLoop::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:grpcagent.UnblockedLoop)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:grpcagent.UnblockedLoop)
  return target;
}

size_t UnblockedLoop::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:grpcagent.UnblockedLoop)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData UnblockedLoop::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    UnblockedLoop::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*UnblockedLoop::GetClassData() const { return &_class_data_; }


void UnblockedLoop::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<UnblockedLoop*>(&to_msg);
  auto& from = static_cast<const UnblockedLoop&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:grpcagent.UnblockedLoop)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void UnblockedLoop::CopyFrom(const UnblockedLoop& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:grpcagent.UnblockedLoop)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool UnblockedLoop::IsInitialized() const {
  return true;
}

void UnblockedLoop::InternalSwap(UnblockedLoop* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(UnblockedLoop, _impl_.body_)
      + sizeof(UnblockedLoop::_impl_.body_)
      - PROTOBUF_FIELD_OFFSET(UnblockedLoop, _impl_.common_)>(
          reinterpret_cast<char*>(&_impl_.common_),
          reinterpret_cast<char*>(&other->_impl_.common_));
}

::PROTOBUF_NAMESPACE_ID::Metadata UnblockedLoop::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_blocked_5floop_2eproto_getter, &descriptor_table_blocked_5floop_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::grpcagent::BlockedLoop*
Arena::CreateMaybeMessage< ::grpcagent::BlockedLoop >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcagent::BlockedLoop >(arena);
}
...
template<> PROTOBUF_NOINLINE ::grpcagent::UnblockedLoop*
Arena::CreateMaybeMessage< ::grpcagent::UnblockedLoop >(Arena* arena) {
  return Arena::CreateMessageInternal< ::grpcagent::UnblockedLoop >(arena);
}
