...
Time::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Time, _impl_.nanoseconds_), 1>(),
     {16, 1, 0, PROTOBUF_FIELD_OFFSET(Time, _impl_.nanoseconds_)}},
    // uint64 seconds = 1;
...
ErrorInfo::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(ErrorInfo, _impl_.message_)}},
    // uint32 code = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ErrorInfo, _impl_.code_), 1>(),
     {8, 1, 0, PROTOBUF_FIELD_OFFSET(ErrorInfo, _impl_.code_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint32 code = 1;
...
CommonResponse::CommonResponse(
  ...
  _impl_.recorded_ = ((cached_has_bits & 0x00000004U) != 0)
...
CommonResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastMtS1,
     {34, 3, 1, PROTOBUF_FIELD_OFFSET(CommonResponse, _impl_.error_)}},
    // string requestId = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(CommonResponse, _impl_.requestid_)}},
    // string command = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(CommonResponse, _impl_.command_)}},
    // .grpcagent.Time recorded = 3;
    {::_pbi::TcParser::FastMtS1,
     {26, 2, 0, PROTOBUF_FIELD_OFFSET(CommonResponse, _impl_.recorded_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string requestId = 1;
