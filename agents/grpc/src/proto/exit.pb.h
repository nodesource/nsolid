...
class ExitBody final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:grpcagent.ExitBody) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR ExitBody(::google::protobuf::internal::ConstantInitialized);
  ...
  ExitBody* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
...
class ExitEvent final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:grpcagent.ExitEvent) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR ExitEvent(::google::protobuf::internal::ConstantInitialized);
  ...
  ExitEvent* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
