...
static const char* NSolidService_method_names[] = {
  ...
  "/grpcagent.NSolidService/ExportCommandError",
...
NSolidService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ExportCommandError_(NSolidService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status NSolidService::Stub::ExportCommandError(::grpc::ClientContext* context, const ::grpcagent::CommandError& request, ::grpcagent::EventResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::grpcagent::CommandError, ::grpcagent::EventResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ExportCommandError_, context, request, response);
}

void NSolidService::Stub::async::ExportCommandError(::grpc::ClientContext* context, const ::grpcagent::CommandError* request, ::grpcagent::EventResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::grpcagent::CommandError, ::grpcagent::EventResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ExportCommandError_, context, request, response, std::move(f));
}

void NSolidService::Stub::async::ExportCommandError(::grpc::ClientContext* context, const ::grpcagent::CommandError* request, ::grpcagent::EventResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ExportCommandError_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::grpcagent::EventResponse>* NSolidService::Stub::PrepareAsyncExportCommandErrorRaw(::grpc::ClientContext* context, const ::grpcagent::CommandError& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::grpcagent::EventResponse, ::grpcagent::CommandError, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ExportCommandError_, context, request);
}

::grpc::ClientAsyncResponseReader< ::grpcagent::EventResponse>* NSolidService::Stub::AsyncExportCommandErrorRaw(::grpc::ClientContext* context, const ::grpcagent::CommandError& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncExportCommandErrorRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
NSolidService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< NSolidService::Service, ::grpcagent::CommandError, ::grpcagent::EventResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](NSolidService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::grpcagent::CommandError* req,
             ::grpcagent::EventResponse* resp) {
               return service->ExportCommandError(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status NSolidService::Service::ExportCommandError(::grpc::ServerContext* context, const ::grpcagent::CommandError* request, ::grpcagent::EventResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
