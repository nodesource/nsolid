...
class NSolidService final {
 public:
  ...
  typedef WithAsyncMethod_Command<WithAsyncMethod_ExportInfo<WithAsyncMethod_ExportPackages<WithAsyncMethod_ExportBlockedLoop<WithAsyncMethod_ExportUnblockedLoop<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Command<WithCallbackMethod_ExportInfo<WithCallbackMethod_ExportPackages<WithCallbackMethod_ExportBlockedLoop<WithCallbackMethod_ExportUnblockedLoop<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_ExportInfo<WithStreamedUnaryMethod_ExportPackages<WithStreamedUnaryMethod_ExportBlockedLoop<WithStreamedUnaryMethod_ExportUnblockedLoop<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_ExportInfo<WithStreamedUnaryMethod_ExportPackages<WithStreamedUnaryMethod_ExportBlockedLoop<WithStreamedUnaryMethod_ExportUnblockedLoop<Service > > > > StreamedService;
};
