...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, 9, -1, sizeof(::grpcagent::EventResponse)},
};
...
PROTOBUF_NDEBUG_INLINE EventResponse::Impl_::Impl_(
    ...
    const ::grpcagent::EventResponse& from_msg)
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL EventResponse::GetClassData() const {
...
EventResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(EventResponse, _impl_.error_message_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string error_message = 1;
    {PROTOBUF_FIELD_OFFSET(EventResponse, _impl_.error_message_), _Internal::kHasBitsOffset + 0, 0,
