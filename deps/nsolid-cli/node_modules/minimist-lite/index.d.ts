 ...
 */
//declare function minimist(args?: string[], opts?: minimist.Opts<{ [key: string]: any }>): minimist.ParsedArgs;
 ...
 * @param [opts] An optional options object to customize the parsing
 */
//declare function minimist<T>(args?: string[], opts?: minimist.Opts<{ [key: string]: any }>): T & minimist.ParsedArgs;
declare function minimist<T>(args?: string[], opts?: minimist.Opts<T>): T & minimist.ParsedArgs;
 ...
 * @param [opts] An optional options object to customize the parsing
 */
declare function minimist<T extends minimist.ParsedArgs>(args?: string[], opts?: minimist.Opts<{ [key: string]: any }>): T;

declare namespace minimist {
    interface Opts<T extends { [key: string]: any }> {
        /**
