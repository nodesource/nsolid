...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {2, sizeof(::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse)},
        {7, sizeof(::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess)},
};
...
ExportMetricsServiceRequest::_table_ = {
  {
    ...
    // repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;
    {PROTOBUF_FIELD_OFFSET(ExportMetricsServiceRequest, _impl_.resource_metrics_), 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
...
ExportMetricsPartialSuccess::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(ExportMetricsPartialSuccess, _impl_.error_message_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(ExportMetricsPartialSuccess, _impl_.rejected_data_points_), 1>(),
     {8, 1, 0, PROTOBUF_FIELD_OFFSET(ExportMetricsPartialSuccess, _impl_.rejected_data_points_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int64 rejected_data_points = 1;
