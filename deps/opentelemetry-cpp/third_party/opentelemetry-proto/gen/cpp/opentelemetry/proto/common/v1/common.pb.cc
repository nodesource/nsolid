...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(InstrumentationScope_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
#endif  // PROTOBUF_CUSTOM_VTABLE
      _impl_(::_pbi::ConstantInitialized()) {
...
const ::uint32_t
    TableStruct_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,
        2,
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::common::v1::EntityRef, _impl_._has_bits_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {46, 58, -1, sizeof(::opentelemetry::proto::common::v1::InstrumentationScope)},
        {62, 74, -1, sizeof(::opentelemetry::proto::common::v1::EntityRef)},
};
...
PROTOBUF_NDEBUG_INLINE AnyValue::Impl_::Impl_(
    ...
    const ::opentelemetry::proto::common::v1::AnyValue& from_msg)
      : value_{},
        _cached_size_{0},
  ...
  switch (value_case()) {
    case VALUE_NOT_SET:
      ...
      case kArrayValue:
        ...
        break;
      case kKvlistValue:
        _impl_.value_.kvlist_value_ = ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.value_.kvlist_value_);
        break;
      case kBytesValue:
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL AnyValue::GetClassData() const {
...
const ::_pbi::TcParseTable<0, 7, 2, 59, 2>
AnyValue::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
void AnyValue::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (const uint32_t oneof_from_case = from._impl_._oneof_case_[0]) {
    ...
    switch (oneof_from_case) {
      ...
      case kKvlistValue: {
        if (oneof_needs_init) {
          _this->_impl_.value_.kvlist_value_ = ::google::protobuf::Message::CopyConstruct(arena, *from._impl_.value_.kvlist_value_);
        } else {
...
PROTOBUF_NDEBUG_INLINE ArrayValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::opentelemetry::proto::common::v1::ArrayValue& from_msg)
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL ArrayValue::GetClassData() const {
...
PROTOBUF_NDEBUG_INLINE KeyValueList::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::opentelemetry::proto::common::v1::KeyValueList& from_msg)
      : values_{visibility, arena, from.values_},
        _cached_size_{0} {}
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL KeyValueList::GetClassData() const {
...
PROTOBUF_NDEBUG_INLINE KeyValue::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::opentelemetry::proto::common::v1::KeyValue& from_msg)
...
class InstrumentationScope::_Internal {
 public:
  using HasBits =
      decltype(std::declval<InstrumentationScope>()._impl_._has_bits_);
  static constexpr ::int32_t kHasBitsOffset =
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, InstrumentationScope_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
...
PROTOBUF_NDEBUG_INLINE InstrumentationScope::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::opentelemetry::proto::common::v1::InstrumentationScope& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull InstrumentationScope_class_data_ =
        InstrumentationScope::InternalGenerateClassData_();

const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL InstrumentationScope::GetClassData() const {
...
InstrumentationScope::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(InstrumentationScope, _impl_.dropped_attributes_count_), 2>(),
     {32, 2, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.dropped_attributes_count_)}},
    // string name = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.name_)}},
    // string version = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.version_)}},
    ...
    // string name = 1;
    {PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.name_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string version = 2;
    {PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.version_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated .opentelemetry.proto.common.v1.KeyValue attributes = 3;
    {PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.attributes_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // uint32 dropped_attributes_count = 4;
    {PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.dropped_attributes_count_), _Internal::kHasBitsOffset + 2, 0,
...
PROTOBUF_NDEBUG_INLINE EntityRef::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::opentelemetry::proto::common::v1::EntityRef& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL EntityRef::GetClassData() const {
...
EntityRef::_table_ = {
  {
    ...
    // string schema_url = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.schema_url_)}},
    // string type = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 1, 0, PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.type_)}},
    ...
    // string schema_url = 1;
    {PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.schema_url_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string type = 2;
    {PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.type_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated string id_keys = 3;
    {PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.id_keys_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String | ::_fl::kRepSString)},
    // repeated string description_keys = 4;
    {PROTOBUF_FIELD_OFFSET(EntityRef, _impl_.description_keys_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String | ::_fl::kRepSString)},
  }},
  // no aux_entries
  {{
