...
inline const ::google::protobuf::RepeatedPtrField<std::string>& EntityRef::id_keys() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedPtrField<std::string>& EntityRef::description_keys() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
