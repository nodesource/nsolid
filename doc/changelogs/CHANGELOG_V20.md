...
## 2024-01-08, Version 20.11.0 'Iron' (LTS), @UlisesGascon
...
* \[[`fecf25ff46`](https://github.com/nodejs/node/commit/fecf25ff46)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
* \[[`ec63a13599`](https://github.com/nodejs/node/commit/ec63a13599)] - **(SEMVER-MINOR)** **module**: remove useCustomLoadersIfPresent flag (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`b3041a0838`](https://github.com/nodejs/node/commit/b3041a0838)] - **(SEMVER-MINOR)** **module**: bootstrap module loaders in shadow realm (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
...
* \[[`23a86e52e7`](https://github.com/nodejs/node/commit/23a86e52e7)] - **(SEMVER-MINOR)** **src**: create per isolate proxy env template (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`444affd8d5`](https://github.com/nodejs/node/commit/444affd8d5)] - **(SEMVER-MINOR)** **src**: make process binding data weak (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
...
* \[[`833190fe7c`](https://github.com/nodejs/node/commit/833190fe7c)] - **crypto**: update root certificates to NSS 3.95 (Node.js GitHub Bot) [#50805](https://github.com/nodejs/node/pull/50805)
* \[[`3cf164312d`](https://github.com/nodejs/node/commit/3cf164312d)] - **deps**: update zlib to 1.2.13.1-motley-5daffc7 (Node.js GitHub Bot) [#50803](https://github.com/nodejs/node/pull/50803)
* \[[`994993ac2e`](https://github.com/nodejs/node/commit/994993ac2e)] - **deps**: update undici to 5.27.2 (Node.js GitHub Bot) [#50813](https://github.com/nodejs/node/pull/50813)
* \[[`02faabac69`](https://github.com/nodejs/node/commit/02faabac69)] - **deps**: V8: cherry-pick 0f9ebbc672c7 (Chengzhong Wu) [#50867](https://github.com/nodejs/node/pull/50867)
* \[[`1910b6b762`](https://github.com/nodejs/node/commit/1910b6b762)] - **deps**: V8: cherry-pick 13192d6e10fa (Levi Zim) [#50552](https://github.com/nodejs/node/pull/50552)
* \[[`4ec7f49ab2`](https://github.com/nodejs/node/commit/4ec7f49ab2)] - **deps**: update zlib to 1.2.13.1-motley-dfc48fc (Node.js GitHub Bot) [#50456](https://github.com/nodejs/node/pull/50456)
* \[[`ac5c0f2ac4`](https://github.com/nodejs/node/commit/ac5c0f2ac4)] - **deps**: update llhttp to 9.1.3 (Node.js GitHub Bot) [#50080](https://github.com/nodejs/node/pull/50080)
...
* \[[`c1a196c897`](https://github.com/nodejs/node/commit/c1a196c897)] - **(SEMVER-MINOR)** **esm**: add import.meta.dirname and import.meta.filename (James Sumners) [#48740](https://github.com/nodejs/node/pull/48740)
* \[[`a42629c9ec`](https://github.com/nodejs/node/commit/a42629c9ec)] - **fs**: use default w flag for writeFileSync with utf8 encoding (Murilo Kakazu) [#50990](https://github.com/nodejs/node/pull/50990)
* \[[`fecf25ff46`](https://github.com/nodejs/node/commit/fecf25ff46)] - **fs**: add c++ fast path for writeFileSync utf8 (CanadaHonk) [#49884](https://github.com/nodejs/node/pull/49884)
* \[[`c160adbf67`](https://github.com/nodejs/node/commit/c160adbf67)] - **fs**: improve error perf of sync `lstat`+`fstat` (CanadaHonk) [#49868](https://github.com/nodejs/node/pull/49868)
...
* \[[`2f6d741f11`](https://github.com/nodejs/node/commit/2f6d741f11)] - **src**: iterate on import attributes array correctly (Michaël Zasso) [#50703](https://github.com/nodejs/node/pull/50703)
* \[[`23a86e52e7`](https://github.com/nodejs/node/commit/23a86e52e7)] - **(SEMVER-MINOR)** **src**: create per isolate proxy env template (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`6b9892b93e`](https://github.com/nodejs/node/commit/6b9892b93e)] - **(SEMVER-MINOR)** **src**: create fs\_dir per isolate properties (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`eb7170c481`](https://github.com/nodejs/node/commit/eb7170c481)] - **(SEMVER-MINOR)** **src**: create worker per isolate properties (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
* \[[`444affd8d5`](https://github.com/nodejs/node/commit/444affd8d5)] - **(SEMVER-MINOR)** **src**: make process binding data weak (Chengzhong Wu) [#48655](https://github.com/nodejs/node/pull/48655)
...
* \[[`e73d91bd48`](https://github.com/nodejs/node/commit/e73d91bd48)] - **stream**: fix enumerability of ReadableStream.from (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`523073f065`](https://github.com/nodejs/node/commit/523073f065)] - **stream**: fix enumerability of ReadableStream.prototype.values (Mattias Buelens) [#50779](https://github.com/nodejs/node/pull/50779)
* \[[`23734d519c`](https://github.com/nodejs/node/commit/23734d519c)] - **stream**: add Symbol.toStringTag to Compression Streams (Filip Skokan) [#50712](https://github.com/nodejs/node/pull/50712)
...
* \[[`2181b58cbf`](https://github.com/nodejs/node/commit/2181b58cbf)] - **v8,tools**: expose necessary V8 defines (Cheng Zhao) [#50820](https://github.com/nodejs/node/pull/50820)
...
* \[[`7af8e20ee8`](https://github.com/nodejs/node/commit/7af8e20ee8)] - **win,tools**: upgrade Windows signing to smctl (Stefan Stojanovic) [#50956](https://github.com/nodejs/node/pull/50956)
