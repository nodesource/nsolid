...
// NSOLID errors
E('ERR_NSOLID_CPU_PROFILE_START',
  'CPU profile could not be started', Error);
E('ERR_NSOLID_CPU_PROFILE_STOP',
  'CPU profile could not be stopped', Error);
E('ERR_NSOLID_CUSTOM_COMMAND_ALREADY_RETURNED',
...
E('ERR_NSOLID_OTEL_API_ALREADY_REGISTERED',
  'OpenTelemetry JS API already registered', Error);

E('ERR_OPERATION_FAILED', 'Operation failed: %s', TypeError);
E('ERR_OUT_OF_RANGE',
