...
function getPackageConfig(path, specifier, base) {
  ...
  const filtered = filterOwnProperties(packageJSON, [
    'imports',
    'main',
    'name',
    'type',
  ...
  // Don't want to pass along package.json paths.
  if (path.substr(-12) !== 'package.json')
    addPackage(path, filtered, true);
  let { imports, main, name, type } = filtered;
