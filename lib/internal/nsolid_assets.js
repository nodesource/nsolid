...
module.exports = ({ heapProfile: _heapProfile,
   ...
   * @param {number} [timeout] It defaults to 600000ms (10 minutes).
   * @param {profileCallback} [cb] called when the profile has started or there has been an error.
   * @example
   ...
   * @param {profileEndCallback} [cb] called when the profile has started or there has been an error.
   * @example
   * const nsolid = require('nsolid');
   * // async version
   * nsolid.profile(600, (err) => {
   ...
   * @param {heapProfileCallback} [cb] called when the profile has started or there has been an error.
   * @example
   * const nsolid = require('nsolid');
   * // async version
   ...
   * @param {heapProfileEndCallback} [cb] called when the profile has started or there has been an error.
   * @example
   * const nsolid = require('nsolid');
   * // async version
   ...
   * @param {number} [duration] duration of the sampling in milliseconds
   ...
   * @param {string} options.flags flags to pass to the profiler. See: https://v8docs.nodesource.com/node-20.3/d7/d76/classv8_1_1_heap_profiler.html#a785d454e7866f222e199d667be567392
   * @param {heapSamplingCallback} [cb] called when the sampling has started or there has been an error.
   * @example
   * const nsolid = require('nsolid');
   ...
   * @param {heapSamplingEndCallback} [cb] called when the sampling has started or there has been an error.
   * @example
   * const nsolid = require('nsolid');
   * // async version
   * nsolid.heapSampling(600, (err) => {
   ...
   * error has happened.
   * @param {snapshotCallback} [cb] called when the snapshot has been generated and sent to the console.
   * @example
   * const nsolid = require('nsolid');
   * // async version
   * nsolid.snapshot((err) => {
