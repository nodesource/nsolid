...
let cachedEbpfSupport = null;
/**
 * @function detectEBPFSupport
 * @description detects if the current system has eBPF support.
 * @example
 * nsolid.detectEBPFSupport();
 * @alias module:nsolid.detectEBPFSupport
 */
function detectEBPFSupport() {
  if (!cachedEbpfSupport) {
    cachedEbpfSupport = binding.detectEBPFSupport();
  }
  return cachedEbpfSupport;
}
