{
  'variables': {
    ...
    'nsolid_sources': [
      ...
      'agents/grpc/src/nsolid_service.grpc.pb.cc',
      'agents/grpc/src/blocked_loop.grpc.pb.cc',
      'agents/grpc/src/blocked_loop.pb.cc',
      'agents/grpc/src/common.grpc.pb.cc',
      'agents/grpc/src/common.pb.cc',
      'agents/grpc/src/event.grpc.pb.cc',
      'agents/grpc/src/event.pb.cc',
      'agents/grpc/src/info.grpc.pb.cc',
      'agents/grpc/src/info.pb.cc',
      'agents/grpc/src/metrics.grpc.pb.cc',
      'agents/grpc/src/metrics.pb.cc',
      'agents/grpc/src/packages.grpc.pb.cc',
      'agents/grpc/src/packages.pb.cc',
      'agents/grpc/src/req_resp.grpc.pb.cc',
      'agents/grpc/src/req_resp.pb.cc',
      'agents/grpc/src/nsolid_service.grpc.pb.h',
      'agents/grpc/src/blocked_loop.grpc.pb.h',
      'agents/grpc/src/blocked_loop.pb.h',
      'agents/grpc/src/common.grpc.pb.h',
      'agents/grpc/src/common.pb.h',
      'agents/grpc/src/event.grpc.pb.h',
      'agents/grpc/src/event.pb.h',
      'agents/grpc/src/info.grpc.pb.h',
      'agents/grpc/src/info.pb.h',
      'agents/grpc/src/metrics.grpc.pb.h',
      'agents/grpc/src/metrics.pb.h',
      'agents/grpc/src/packages.grpc.pb.h',
      'agents/grpc/src/packages.pb.h',
      'agents/grpc/src/req_resp.grpc.pb.h',
      'agents/grpc/src/req_resp.pb.h',
