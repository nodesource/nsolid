...
#undef V
  ...
  LocalVector<Name> module_format_keys(isolate);
  LocalVector<Value> module_format_values(isolate);
  module_format_keys.push_back(FIXED_ONE_BYTE_STRING(isolate, "kCommonJS"));
  module_format_values.push_back(
      Integer::New(isolate, static_cast<int>(ModuleFormat::kCommonJS)));
  module_format_keys.push_back(FIXED_ONE_BYTE_STRING(isolate, "kModule"));
  module_format_values.push_back(
      Integer::New(isolate, static_cast<int>(ModuleFormat::kModule)));
  USE(target->Set(context,
                  FIXED_ONE_BYTE_STRING(isolate, "moduleFormats"),
                  Object::New(isolate,
                              Null(isolate),
                              module_format_keys.data(),
                              module_format_values.data(),
                              module_format_keys.size())));
}
